...
import ai.sinay.aelb.domain.Attachment;
import ai.sinay.aelb.repository.AttachmentRepository;
...
/**
 * REST controller for managing {@link ai.sinay.aelb.domain.Attachment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
