...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ai.sinay.aelb.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ai.sinay.aelb.repository.UserRepository.USERS_BY_EMAIL_CACHE);
